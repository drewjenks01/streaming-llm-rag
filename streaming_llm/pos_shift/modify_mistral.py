...
from transformers.models.mistral.modeling_mistral import repeat_kv, rotate_half, MistralAttention
import types
    ...
    for name, module in reversed(model._modules.items()):
        ...
        if isinstance(module, MistralAttention):
            model._modules[name].forward = types.MethodType(
                mistral_pos_shift_attention_forward, model._modules[name]
            )
